...
use crate::domain::entity::{
    aggregate::Aggregate, event::{Event, EventEnvelope}, snapshot::AggregateSnapshot,
};
...
impl<A: Default + Debug + Into<B>, B: Event> Into<EventEnvelope<B>>
...
impl<Q: Default + Debug + Into<S>, S: Aggregate + Default> Into<AggregateSnapshot<S>>
